...
class AirlineReservationSystemTest {
    ...
    void testReserveSeat_SeatUnavailable() {
        assertThrows(SeatUnavailableException.class, () -> system.reserveSeat("QA234", 1,
                "Jane Doe"));
    }
   ...
   /* // Тест 3: Отмена резервации для свободного места
    ...
    void testReserveSeat_EmptyFlightNumber() {
        assertThrows(IllegalArgumentException.class, () -> system.reserveSeat("", 1, "John Doe"));
    }
    ...
    void testReserveSeat_NegativeSeatNumber() {
        assertThrows(IllegalArgumentException.class, () -> system.reserveSeat("QA234", -1, "John Doe"));
    }

    // Тест 8: Проверка на неправильный номер рейса в методе reserveSeat
    @Test
    void testReserveSeat_InvalidFlightNumber() {
        assertThrows(IllegalArgumentException.class, () -> system.reserveSeat("INVALID_FLIGHT", 1, "John Doe"));
    }
