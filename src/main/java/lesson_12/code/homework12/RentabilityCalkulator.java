...
// В одном массиве хранится стоимость аренды за месяц для нескольких объектов недвижимости,
// в другом — их цена продажи. Напишите программу,
// которая вычислит и выведет рентабельность аренды для каждого объекта (отношение стоимости аренды к стоимости недвижимости).
// Пример: int[] rentPrices = {1200, 1500, 1800, 1300, 1600};int[] sellPrices = {250000, 300000, 350000, 280000, 320000};

public class RentabilityCalkulator {
    public static void main(String[] args) {
        ...
        if(rentPrices.length != sellPrices.length){
            System.out.println("Вероятно вы допустили ошибку! Mассивы должны иметь одинаковую длинну! ");
            return;
        }
